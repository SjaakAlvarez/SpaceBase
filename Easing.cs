...
namespace SpaceBaseMono
{
    public static class Easing
    {
        public static float Ease(double linearStep, float acceleration, EasingType type)
        {
            ...
            return MathHelper.Lerp((float)linearStep, (float)easedStep, Math.Abs(acceleration));
        }
        ...
        static class Sine
        {
            ...
            {
                return (float)Math.Sin(s * MathHelper.Pi/2 - MathHelper.Pi/2) + 1;
            }
            public static float EaseOut(double s)
            {
                return (float)Math.Sin(s * MathHelper.Pi/2);
            }
            public static float EaseInOut(double s)
            {
                return (float)(Math.Sin(s * MathHelper.Pi - MathHelper.Pi/2) + 1) / 2;
            }
        }
